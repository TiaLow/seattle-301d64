...
function displayPics(){
  ...
  // TODO: The previous line of code (consol.log(rando);) threw an error because it wanted to use the variable rando which is declared with let, which is scoped inside the code block from lines 32-37. The console log of that variable is outside of the code block that it is scoped within. 
  console.log(viewed);
